...
class confirmed extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  constructor(...args) {
    super(...args);
  ...
  render() {
    ...
    return __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, __jsx(_Components_Header_MainMenu__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"], {
      ...
      className: "lowerSpace"
    }, "Confirmed:", __jsx("strong", null, addComma(key.confirmed))), __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_6__["Card"].Description, {
      className: "lowerSpace"
